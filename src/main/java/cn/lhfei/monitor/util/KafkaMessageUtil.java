...
public class KafkaMessageUtil {
	...
	protected final static Logger logger = LoggerFactory.getLogger(KafkaMessageUtil.class);
		...
		for (Entry entry : entrys) {
			...
			if (entry.getEntryType() == EntryType.ROWDATA) {
				...
				logger.info(row_format, new Object[] { entry.getHeader().getLogfileName(),
						...
						simpleDateFormat.format(date), entry.getHeader().getGtid(), String.valueOf(delayTime) });
